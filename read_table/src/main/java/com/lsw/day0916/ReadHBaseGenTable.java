...
//						String rowkey = date + "\001" + userEntry.getKey()
...
//							if(iDisplayLength-iDisplayStart<=result[1].size()-1){
//								iDisplayLength=result[1].size()-1-iDisplayStart;
//							}
...
//		allObject.put("iTotalDisplayRecords", local);
//		allObject.put("iTotalRecords", result[1].size());
//		return allObject;
//
//	}
...
//												+ "-->" + resultMap.get(i));
	...
	public static void main(String[] args) {
		...
		JSONObject jsonObject = new JSONObject();
		try {
			 jsonArraynew = rht.genFlowL2Hbase_day("2014/11/1", "2014/11/20",
			 "0", appMap, "AppTraffic_UP", devList);
			 jsonArraynew2 = rht.genFlowL2_SumHbase_day("2014/11/1",
			 "2014/11/20", "0", appMap, "AppTraffic_UP", devList);
			 jsonArray = rht.genFlowPieHbase_day("2014/11/1", "2014/11/20",
			 "0",
			 appMap, "AppTraffic_UP", devList);
			 jsonArray1 = rht.genFlowPie_SumHbase_day("2014/11/1",
			 "2014/11/20",
			 "0", appMap, "AppTraffic_UP", devList);
			 jsonArray2 = rht.genFlowTop10Hbase_day("2014/11/1", "2014/11/20",
			 "0", appMap, "AppTraffic_UP", devList);
			 jsonArray3 = rht.genFlowTotalInfoHbase();
			jsonObject = rht.genFlowDetailsHbase_day("2014/11/1",  "2014/11/20",appMap2, appMap,
					devList, 6, 5);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
